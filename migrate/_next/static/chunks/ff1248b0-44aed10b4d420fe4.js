...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [660], {
        26915: function(e, t, i) {
            ...
            let Q = (0, c.createContext)(void 0);

            function useScreenContext() {
                let e = (0, c.useContext)(Q);
                if (!e) throw Error("useScreenContext must be used within a <ScreenProvider />");
                return e
            }

            function shortenString(e, t) {
                return `${e.substring(0,t?4:6)}...${e.substring(e.length-(t?3:4))}`
            }

            function shortenAddress(e, t) {
                try {
                    let i = y.getAddress(e);
                    return shortenString(i, t)
                } catch {
                    return e
                }
            }
            let ExportLocalWallet = e => {
                let [t, i] = (0, c.useState)(""), [s, n] = (0, c.useState)(!1), [o, d] = (0, c.useState)(!1), [M, j] = (0, c.useState)(!1), x = (0, r.Osb)(), u = (0, r.SFn)(), [g, h] = (0, c.useState)(""), N = (0, r.xUo)(), y = (0, c.useRef)(!1);
                (0, c.useEffect)(() => {
                    y.current || (y.current = !0, (async () => {
                        if (x && x instanceof L.S) {
                            u && h(u);
                            let e = await x.getSavedData();
                            e ? .address !== u && j(!0)
                        } else {
                            let t = N(e.localWalletConfig),
                                i = await t.getSavedData();
                            i && h(i.address)
                        }
                    })())
                }, [x, e.localWalletConfig, N, t, u]);
                let exportFromLocalStorage = async () => {
                    if (x && x instanceof L.S) {
                        let i = await x.getSavedData();
                        if (i && i.address === u) downloadJsonWalletFile(i.data), e.onExport();
                        else try {
                            let i = await x.export({
                                password: t,
                                strategy: "encryptedJson"
                            });
                            downloadJsonWalletFile(i), e.onExport()
                        } catch (e) {
                            console.error(e), d(!0)
                        }
                    } else {
                        let t = N(e.localWalletConfig),
                            i = await t.getSavedData();
                        downloadJsonWalletFile(i.data), e.onExport()
                    }
                };
                return g ? (0, C.jsx)(l.C, {
                    fullHeight: !0,
                    children: (0, C.jsxs)("form", {
                        ...
                        onSubmit: e => {
                            e.preventDefault(), exportFromLocalStorage()
                        },
                        children: [(0, C.jsxs)(l.C, {
                            expand: !0,
                            p: "lg",
                            children: [(0, C.jsx)(l.M, {
                                ...
                                children: shortenAddress(g)
                            }), M && (0, C.jsxs)(C.Fragment, {
                                children: [(0, C.jsx)(l.S, {
                                    y: "lg"
                                }), (0, C.jsx)("input", {
                                    type: "text",
                                    name: "username",
                                    ...
                                    right: {
                                        onClick: () => n(!s),
                                        icon: s ? (0, C.jsx)(a.LAO, {}) : (0, C.jsx)(a.hsE, {})
                                    },
                                    label: "Password",
                                    type: s ? "text" : "password",
                                    value: t,
                                    error: o ? "Wrong Password" : "",
                            ...
                            style: {
                                borderTop: "wide" === e.modalSize ? "none" : void 0
                            },
                            children: (0, C.jsxs)(l.B, {
                                disabled: o,
                                variant: "accent",
                                fullWidth: !0,
                                style: {
            ...
            function downloadJsonWalletFile(e) {
                let t = JSON.parse(e),
                ...
                n.href = s, n.download = "wallet.json", document.body.appendChild(n), n.style.display = "none", n.click(), URL.revokeObjectURL(n.href)
            }
            let W = o.Z.p `
  font-size: ${l.f.md};
  ...
  margin: 0;
`,
                P = "ipfs://QmcxZHpyJa8T4i63xqjPYrZ6tKrt55tZJpbXcjSDKuKaf9/ethereum/512.png",
                ChainIcon = e => {
                    let t = e.chain ? .icon ? .url || P,
                        i = (0, r.y$C)(),
                        s = i ? i.resolveScheme(t) : t.replace("ipfs://", "https://ipfs.io/ipfs/");
                    return (0, C.jsxs)("div", {
                        style: {
                            position: "relative",
                            display: "flex",
                        ...
                        children: [(0, C.jsx)("img", {
                            src: s || P,
                            onError: e => {
                                e.currentTarget.src !== P && (e.currentTarget.src = P)
                            },
                            alt: "",
                            width: e.size,
                            height: e.size,
                ...
                CopyIcon = e => {
                    ...
                    return (0, C.jsx)("div", {
                        ...
                        children: (0, C.jsx)(N.T, {
                            ...
                            side: e.side,
                            align: e.align,
                            children: e.hasCopied || t ? (0, C.jsx)(G, {}) : (0, C.jsx)(a.TIy, {})
                        })
                    })
                },
                G = (0, o.Z)(a.nQG)
...
`, $ = o.Z.div `
  ...
  position: fixed;
  inset: 0;
  animation: ${H} 400ms cubic-bezier(0.16, 1, 0.3, 1);
...
`;
            ...
            let Modal = e => (0, C.jsxs)(A.fC, {
                    open: e.open,
                    onOpenChange: e.setOpen,
                    children: [e.trigger && (0, C.jsx)(A.xz, {
                        asChild: !0,
                        children: e.trigger
                    }), (0, C.jsxs)(A.h_, {
                        children: [(0, C.jsx)(A.aV, {
                            asChild: !0,
                            children: (0, C.jsx)($, {})
                        }), (0, C.jsx)(A.VY, {
                            asChild: !0,
                            children: (0, C.jsxs)(X, {
                                style: {
                                    height: "compact" === e.size ? "auto" : l.w,
                                    maxWidth: "compact" === e.size ? l.t : l.v
                                },
                                children: ["compact" === e.size ? (0, C.jsxs)(DynamicHeight, {
                                    maxHeight: l.x,
                                    children: [e.children, " "]
                                }) : e.children, !e.hideCloseIcon && (0, C.jsx)(V, {
                                    children: (0, C.jsx)(A.x8, {
                                        asChild: !0,
                                        children: (0, C.jsx)(l.I, {
                                            type: "button",
                                            "aria-label": "Close",
                                            children: (0, C.jsx)(a.Pxu, {
                                                style: {
                                                    width: l.i.md,
                                                    height: l.i.md,
                                                    color: "inherit"
...
`,
  ...
  ${l.o.mobile} {
    ...
    transform: none;
    width: 100vw;
    animation: ${J} 0.35s cubic-bezier(0.15, 1.15, 0.6, 1);
...
`,
  ...
  animation: ${_} 500ms ease-in-out infinite alternate;
  border-radius: ${l.d.sm};
`;

            function CustomThemeProvider(e) {
                let t;
                let {
                    theme: i,
                    children: s
                } = e;
                return t = "string" == typeof i ? "light" === i ? l.y : l.z : i, (0, C.jsx)(x.a, {
                    theme: t,
                    children: s
                })
            }
            let K = {
                ...
                NetworkSelector = e => {
                    let [t, i] = (0, c.useState)(""), s = (0, c.useDeferredValue)(t), n = (0, x.u)(), o = e.theme || n || "dark", a = (0, r.EnH)(), d = e.chains || a, M = e.recentChains, j = M ? e.popularChains ? .filter(e => !M.some(t => t.chainId === e.chainId)) : e.popularChains, u = (0, c.useMemo)(() => new D.Z(d, K), [d]), g = (0, c.useMemo)(() => new D.Z(j || [], K), [j]), h = (0, c.useMemo)(() => new D.Z(e.recentChains || [], K), [e.recentChains]), N = (0, c.useMemo)(() => "" === s ? d : u.search(s).map(e => e.item), [u, s, d]), y = (0, c.useMemo)(() => "" === s ? j || [] : g.search(s).map(e => e.item), [g, s, j]), T = (0, c.useMemo)(() => "" === s ? e.recentChains || [] : h.search(s).map(e => e.item), [h, s, e.recentChains]), {
                        onClose: I,
                        onSwitch: L,
                        onCustomClick: w
                    } = e, p = (0, c.useCallback)(e => {
                        L && L(e), I && I()
                    }, [L, I]);
                    return (0, C.jsx)(CustomThemeProvider, {
                        theme: o,
                        children: (0, C.jsx)(Modal, {
                            size: "compact",
                            open: !0,
                            setOpen: e => {
                                !e && I && I()
                            ...
                            style: {
                                paddingBottom: e.onCustomClick ? l.s.md : "0px"
                            },
                            children: (0, C.jsxs)(l.C, {
                                children: [(0, C.jsx)(l.C, {
                                    p: "lg",
                                    ...
                                    children: [(0, C.jsx)(l.C, {
                                        ...
                                        y: "lg"
                                    }), d.length > 10 && (0, C.jsxs)(C.Fragment, {
                                        children: [(0, C.jsx)(l.C, {
                                            px: "lg",
                                            children: (0, C.jsxs)("div", {
                                                ...
                                                children: [(0, C.jsx)(eo, {
                                                    ...
                                                    style: {
                                                        padding: `${l.s.sm} ${l.s.md} ${l.s.sm} ${l.s.xxl}`
                                                    },
                                                    tabIndex: -1,
                                                    variant: "outline",
                                        ...
                                        px: "md",
                                        children: [(0, C.jsx)(m.VY, {
                                            className: "TabsContent",
                                            value: "all",
                                            style: {
                                                outline: "none"
                                            },
                                            children: (0, C.jsx)(NetworkTab, {
                                                allChains: N,
                                                type: "all",
                                                popularChains: y,
                                                recentChains: T,
                                                onSwitch: p,
                                                renderChain: e.renderChain,
                                                close: e.onClose
                                            })
                                        }), (0, C.jsx)(m.VY, {
                                            className: "TabsContent",
                                        ...
                                        children: [(0, C.jsx)(l.L, {}), (0, C.jsx)(l.C, {
                                            p: "lg",
                ...
                filterChainByType = (e, t) => "all" === t ? e : "testnet" === t ? e.filter(e => e.testnet) : e.filter(e => !e.testnet),
                NetworkTab = e => {
                    let t = (0, c.useMemo)(() => filterChainByType(e.allChains, e.type), [e.type, e.allChains]),
                        i = (0, c.useMemo)(() => filterChainByType(e.recentChains || [], e.type), [e.type, e.recentChains]),
                        s = (0, c.useMemo)(() => filterChainByType(e.popularChains || [], e.type), [e.type, e.popularChains]);
                    return (0, C.jsxs)(l.C, {
                        scrollY: !0,
                        animate: "fadein",
                        style: {
                            height: "330px",
                            paddingBottom: l.s.lg
                        },
                        children: [i.length > 0 && (0, C.jsxs)("div", {
                            children: [(0, C.jsx)(ei, {
                        ...
                        }), (s.length > 0 || i.length > 0) && (0, C.jsxs)(C.Fragment, {
                            children: [(0, C.jsx)(ei, {
                ...
                ee = (0, c.memo)(function(e) {
                    ...
                    let handleSwitch = async i => {
                            a(-1), n(i.chainId);
                            try {
                                await t(i.chainId), e.onSwitch(i)
                            } catch (e) {
                                a(i.chainId), console.error(e)
                            } finally {
                                n(-1)
                            }
                        },
                        M = e.renderChain,
                        [j, x] = (0, c.useState)(e.chains.length > 100);
                    return ((0, c.useEffect)(() => {
                        j && x(!1)
                    }, [j]), j) ? (0, C.jsx)(l.C, {
                        flex: "row",
                        ...
                        children: e.chains.map(t => {
                            ...
                            return M ? (0, C.jsx)("li", {
                                children: (0, C.jsx)(M, {
                                    ...
                                    chain: t,
                                    switching: s === t.chainId,
                                    switchFailed: o === t.chainId,
                                    close: e.close
                                })
                            }, t.chainId) : (0, C.jsx)("li", {
                                children: (0, C.jsxs)(en, {
                                    "data-active": i === t.chainId,
                                    onClick: () => {
                                        handleSwitch(t)
                                    },
                                    children: [(0, C.jsx)(ChainIcon, {
                                        chain: t,
                                        size: l.i.lg,
                                        active: i === t.chainId,
                                        loading: "lazy"
...
`, ExitIcon = e => {
            ...
            function SendFunds(e) {
                let t;
                let [i, s] = (0, c.useState)("base"), n = (0, r.xxU)();
                if (n && e.supportedTokens[n] && e.supportedTokens[n] !== B[n]) {
                    let i = e.supportedTokens[n],
                        s = i && i[0];
                    s && (t = s)
                }
                let [o, a] = (0, c.useState)(t), [l, d] = (0, c.useState)(""), [M, j] = (0, c.useState)("0");
                return "tokenSelector" === i ? (0, C.jsx)(TokenSelector, {
                ...
                }) : (0, C.jsx)(SendFundsForm, {
                    token: o,
                    onTokenSelect: () => {
                        s("tokenSelector")
                    },
                    receieverAddress: l,
                    setReceieverAddress: d,
                    amount: M,
                    setAmount: j
                })
            }

            function SendFundsForm(e) {
                let t = e.token ? .address,
                    i = (0, r.KQd)(t),
                    {
                        receieverAddress: s,
                        setReceieverAddress: n,
                        amount: o,
                        setAmount: M
                    } = e,
                    j = (0, r.AbE)(),
                    ...
                    g = 1 === x || 5 === x || 4 === x,
                    h = (0, c.useMemo)(() => {
                        let e = s.endsWith(".eth");
                        return (!!g || !e) && (e || y.isAddress(s))
                    }, [s, g]),
                    N = s && !h,
                    m = (0, d.D)(async () => {
                        if (u) return u.transfer(s, o, t)
                    });
                if (m.isError) return (0, C.jsxs)(l.C, {
                    p: "lg",
                    animate: "fadein",
                    children: [(0, C.jsx)(l.M, {
                        title: "Send Funds",
                        ...
                        children: [(0, C.jsx)(a.xrR, {
                            ...
                            children: function(e) {
                                ...
                                return t ? t.includes("user rejected") ? "Transaction Rejected" : t.includes("insufficient funds") ? "Insufficient funds" : "Transaction Failed" : "Transaction Failed"
                            }(m.error)
                        })]
                    })]
                });
                if (m.isSuccess) return (0, C.jsxs)(l.C, {
                    p: "lg",
                    animate: "fadein",
                    children: [(0, C.jsx)(l.M, {
                        title: "Send Funds",
                ...
                let D = e.token ? .name || i ? .data ? .name,
                    T = e.token ? .symbol || i.data ? .symbol;
                return (0, C.jsxs)(l.C, {
                    p: "lg",
                    animate: "fadein",
                    children: [(0, C.jsx)(l.a, {
                        ...
                        children: [(0, C.jsx)(l.h, {
                            ...
                            onClick: e.onTokenSelect,
                            children: [e.token ? (0, C.jsx)(l.D, {
                                src: e.token.icon,
                                width: l.i.lg,
                                height: l.i.lg
                            }) : (0, C.jsx)(ChainIcon, {
                            ...
                            type: "submit",
                            onClick: async () => {
                                s && u && o && await m.mutateAsync()
                            },
                            style: {
                                alignItems: "center",
                                gap: l.s.sm
                            },
                            children: [m.isLoading ? "Sending" : "Send", m.isLoading && (0, C.jsx)(l.c, {
                                size: "sm",
            ...
            function TokenSelector(e) {
                let [t, i] = (0, c.useState)(""), s = (0, r.xxU)(), n = function() {
                    let e = (0, r.KQd)(),
                        t = (0, r.AbE)();
                    if (e.data) return {
                        name: e.data.name,
                    ...
                    let t = (0, r.KQd)(e),
                        i = (0, r.AbE)();
                    return y.isAddress(e) ? t.isLoading ? {
                        isLoading: !0,
                        data: void 0
                    } : t.data ? {
                        isLoading: !1,
                ...
                }(t), M = (s ? e.supportedTokens[s] : void 0) || [];
                n && (M = [n, ...M]), o && (M = [o, ...M]);
                let j = t ? M.filter(e => {
                    let i = t.toLowerCase();
                    return e.name.toLowerCase().includes(i) || e.symbol.toLowerCase().includes(i) || e.address.includes(t)
                }) : M;
                return (0, C.jsxs)(l.C, {
                    animate: "fadein",
                    children: [(0, C.jsxs)(l.C, {
                        ...
                        children: j.map(t => (0, C.jsx)(SelectTokenButton, {
                            onClick: () => e.onTokenSelect(t),
                            token: t
                        }, t.address))
                    }), d && (0, C.jsx)(l.C, {
                        animate: "fadein",
            ...
            function SelectTokenButton(e) {
                let t = (0, r.KQd)(e.token ? .address),
                    i = (0, r.AbE)(),
                    s = e.token ? .name || t.data ? .name;
                return (0, C.jsxs)(ea, {
                    fullWidth: !0,
                    variant: "secondary",
                    onClick: e.onClick,
                    children: [e.token ? .icon ? (0, C.jsx)(l.D, {
                        width: l.i.lg,
                        height: l.i.lg,
                        src: e.token.icon
                    }) : (0, C.jsx)(ChainIcon, {
...
`;
            ...
            function formatBalance(e) {
                return Number(e.displayValue).toFixed(3) + " " + e.symbol
            }
            let el = o.Z.div `
  position: absolute;
  top: 50%;
            ...
            function ReceiveFunds(e) {
                ...
                return (0, C.jsxs)(l.C, {
                    ...
                    children: [(0, C.jsx)(l.M, {
                        ...
                        multiline: !0,
                        center: !0,
                        children: ["Copy the wallet address to ", (0, C.jsx)("br", {}), "send funds to this wallet"]
                    })]
                })
            }
            let er = o.Z.button `
...
`,
                ec = "tw-connected-wallet",
                ConnectedWalletDetails = e => {
                    let t = (0, r.AbE)(),
                        i = (0, r.xxU)(),
                        s = (0, r.qL0)(),
                        n = (0, r.EnH)(),
                        o = (0, r.SFn)(),
                        d = i && e.displayBalanceToken ? e.displayBalanceToken[i] : void 0,
                        M = (0, r.KQd)(d),
                        j = (0, r.Osb)(),
                        x = (0, r.w_p)(),
                        u = (0, r.UvD)(),
                        ...
                        [k, Y] = (0, c.useState)(!1),
                        Z = (0, r.eC)(),
                        O = j ? .getPersonalWallet(),
                        U = O && y.getWalletConfig(O),
                        v = g && y.getWalletConfig(g),
                        B = !!O,
                        Q = j && j instanceof w.t,
                        W = o ? shortenString(o) : "",
                        P = j ? .walletId === p.w.smartWallet;
                    P && (m = N.s);
                    let F = u.data ? .ens || W,
                        G = u.data ? .avatarUrl,
                        H = e.detailsBtn ? (0, C.jsx)("div", {
                            children: (0, C.jsx)(e.detailsBtn, {})
                        }) : (0, C.jsxs)(eM, {
                            type: "button",
                            className: `${ec} ${e.className||""}`,
                            style: e.style,
                            ...
                            children: [(0, C.jsx)(l.D, {
                                ...
                                flex: "column",
                                gap: "xs",
                                children: [j ? .walletId === p.w.localWallet ? (0, C.jsx)(l.b, {
                                    color: "danger",
                                    size: "xs",
                                    style: {
                                        minWidth: "70px"
                                    ...
                                    color: "primaryText",
                                    weight: 500,
                                    className: `${ec}__address`,
                                    children: F
                                }) : (0, C.jsx)(Skeleton, {
                                    height: l.f.sm,
                                    width: "88px"
                                }), M.data ? (0, C.jsxs)(l.b, {
                                    className: `${ec}__balance`,
                                    size: "xs",
                                    weight: 500,
                                    children: [Number(M.data.displayValue).toFixed(3), " ", M.data.symbol]
                                }) : (0, C.jsx)(Skeleton, {
                                    height: l.f.xs,
                                    width: "82px"
                                })]
                        ...
                        $ = (0, C.jsx)(N.T, {
                            tip: B ? "Network Switching is disabled" : "Switch Network",
                            children: (0, C.jsxs)(ex, {
                                ...
                                children: [(0, C.jsx)("div", {
                                    ...
                                    color: "primaryText",
                                    multiline: !0,
                                    children: t ? .name || `Unknown chain #${i}`
                                }), (0, C.jsx)(eg, {
                                    width: l.i.sm,
                                    height: l.i.sm,
                                    style: {
                            ...
                            children: [(0, C.jsxs)(l.C, {
                                ...
                                children: [(0, C.jsx)(l.D, {
                                    ...
                                    children: [(0, C.jsxs)(l.C, {
                                        ...
                                        weight: 500,
                                        size: "sm",
                                        children: [" ", M.data ? Number(M.data.displayValue).toFixed(3) : (0, C.jsx)(Skeleton, {
                                            height: "1em",
                                            width: "100px"
                                        }), " ", M.data ? .symbol, " "]
                                    })]
                                ...
                                y: "lg"
                            }), (0, C.jsx)(ConnectedToSmartWallet, {}), (0, C.jsxs)(l.C, {
                                style: {
                                    display: "grid",
                                ...
                                flex: "column",
                                gap: "sm",
                                children: [O && U && (0, C.jsx)(WalletSwitcher, {
                                    wallet: O,
                                    name: "Personal Wallet",
                                    onSwitch: () => {
                                        h(j)
                                    }
                                }), v && g && (0, C.jsx)(WalletSwitcher, {
                                    name: g.walletId === p.w.smartWallet ? "Smart Wallet" : v.meta.name,
                                    wallet: g,
                                    onSwitch: () => {
                                        h(void 0)
                                    }
                                }), Q && x && x.isInstalled && x.isInstalled() && !(0, l.e)() && (0, C.jsxs)(ex, {
                                    type: "button",
                                    onClick: () => {
                                        j.switchAccount(), Y(!1)
                                    },
                                    ...
                                    children: [(0, C.jsx)(l.C, {
                                        color: "secondaryText",
                                        children: (0, C.jsx)(a.jH6, {
                                            width: l.i.sm,
                                            height: l.i.sm
                                        })
                                    }), "Switch Account"]
                                }), !e.hideTestnetFaucet && (t ? .faucets && t.faucets.length > 0 || t ? .chainId === I.YY$.chainId) && (0, C.jsxs)(eu, {
                                    href: t ? .faucets ? t.faucets[0] : "#",
                                    target: "_blank",
                                    as: "a",
                                    onClick: async e => {
                                        t.chainId === I.YY$.chainId && (e.preventDefault(), Y(!1), await Z ? .wallet.requestFunds(10), await M.refetch())
                                    },
                                    style: {
                                        textDecoration: "none",
                                        color: "inherit",
                                    ...
                                    children: [(0, C.jsx)(l.C, {
                                        ...
                                        center: "both",
                                        color: "secondaryText",
                                        children: (0, C.jsx)(FundsIcon, {
                                            size: l.i.sm
                                        })
                                    }), "Request Testnet Funds"]
                                }), t ? .explorers && t.explorers[0] ? .url && (0, C.jsxs)(eu, {
                                    href: t.explorers[0].url + "/address/" + o,
                                    target: "_blank",
                                    as: "a",
                                    style: {
                                        textDecoration: "none",
                                    ...
                                    children: [(0, C.jsx)(l.C, {
                                        ...
                                        center: "both",
                                        color: "secondaryText",
                                        children: (0, C.jsx)(a.rrd, {
                                            width: l.i.sm,
                                            height: l.i.sm
                                        })
                                    }), "Transaction History"]
                                }), j ? .walletId === p.w.localWallet && (0, C.jsxs)("div", {
                                    children: [(0, C.jsxs)(ex, {
                                        onClick: () => {
                                            b(!0), Y(!1)
                                        },
                                        ...
                                        multiline: !0,
                                        color: "danger",
                                        children: ["This is a temporary guest wallet ", (0, C.jsx)("br", {}), "Backup if you ", "don't ", "want to lose access to it"]
                                    })]
                                })]
                            })]
                        });
                    return (0, C.jsxs)(C.Fragment, {
                        children: [(0, l.e)() ? (0, C.jsx)(Modal, {
                            size: "compact",
                            trigger: H,
                            open: k,
                            setOpen: Y,
                            ...
                            open: k,
                            onOpenChange: Y,
                            children: [(0, C.jsx)(T.xz, {
                                asChild: !0,
                                children: H
                            }), (0, C.jsx)(T.Uv, {
                                children: (0, C.jsx)(ed, {
                                    asChild: !0,
                                    side: e.dropdownPosition ? .side || "bottom",
                                    align: e.dropdownPosition ? .align || "end",
                                    sideOffset: 10,
                                    children: V
                                })
                            })]
                        }), D && (0, C.jsx)(NetworkSelector, {
                            theme: e.theme,
                            chains: n,
                            ...e.networkSelector,
                            onClose: () => L(!1)
                            ...
                            open: !0,
                            setOpen: b,
                            children: (0, C.jsx)(ExportLocalWallet, {
                                modalSize: "compact",
                                localWalletConfig: x,
                                onBack: () => {
                                    b(!1)
...
`,
  ...
  border-radius: ${l.d.lg};
  padding: ${l.s.lg};
  animation: ${eC} 400ms cubic-bezier(0.16, 1, 0.3, 1);
...
`;
            ...
            function ConnectedToSmartWallet() {
                let e = (0, r.Osb)(),
                    ...
                    [s, n] = (0, c.useState)(!1);
                (0, c.useEffect)(() => {
                    e && e.walletId === p.w.smartWallet ? e.isDeployed().then(e => {
                        n(e)
                    }) : n(!1)
                }, [e]);
                let o = (0, C.jsxs)(l.C, {
                    ...
                    children: [(0, C.jsxs)(l.C, {
                        ...
                        gap: "xs",
                        center: "y",
                        children: [(0, C.jsx)(eN, {}), "Connected to Smart Wallet"]
                    }), s && (0, C.jsx)(a.XCv, {
                        width: l.i.sm,
                        height: l.i.sm
                    })]
                });
                return t && i && e ? .walletId === p.w.smartWallet ? (0, C.jsxs)(C.Fragment, {
                    children: [s ? (0, C.jsx)(l.F, {
                        color: "secondaryText",
                        hoverColor: "primaryText",
                        href: `https://thirdweb.com/${t.slug}/${i}/account`,
                        target: "_blank",
                        size: "sm",
                        children: o
                    }) : (0, C.jsxs)(l.b, {
            ...
            let LockIcon = e => (0, C.jsx)("svg", {
                    ...
                    return (0, C.jsx)(Modal, {
                        ...
                        children: (0, C.jsxs)(l.C, {
                            ...
                            children: [(0, C.jsx)(l.S, {
                                ...
                                flex: "column",
                                center: "x",
                                children: [t && (0, C.jsx)(b.W, {
                                    error: !1,
                                    onRetry: () => {},
                                    iconUrl: t.meta.iconURL
                                }), (0, C.jsx)(l.S, {
                                    y: "xxl"
                                }), (0, C.jsx)(l.a, {
                                    ...
                                    multiline: !0,
                                    center: !0,
                                    children: ["Sign the signature request ", (0, C.jsx)("br", {}), " in your wallet"]
                                }), (0, C.jsx)(l.S, {
                                    y: "lg"
                                })]
                            })]
                ...
                ConnectWallet = e => {
                    let t = (0, r.Osb)(),
                        ...
                        n = (0, r.pX8)(),
                        o = (0, r.rBi)(),
                        a = "connecting" === n || "unknown" === n,
                        d = e.btnTitle || "Connect Wallet",
                        M = (0, l.m)(),
                        j = (0, c.useContext)(l.G),
                        u = (0, r.SFn)(),
                        [g, h] = (0, c.useState)(!1),
                        N = (0, r.Jgv)(),
                        {
                        ...
                        T = (0, r.DUm)(),
                        {
                            activeChainSetExplicitly: I
                        } = (0, r.tNP)(),
                        L = !e.auth ? .loginOptional && !!N ? .authUrl && !!u && !y ? .address,
                        signIn = async () => {
                            try {
                                h(!0);
                                let t = await m();
                        ...
                        w = (0, c.useMemo)(() => {
                            if (!e.supportedTokens) return B;
                            let t = { ...B
                            };
                            for (let i in e.supportedTokens) {
                                let s = Number(i),
                                    n = e.supportedTokens[s];
                                n && (t[s] = n)
                            }
                            return t
                        }, [e.supportedTokens]);
                    return (0, C.jsxs)(CustomThemeProvider, {
                        theme: s,
                        children: [g && (0, C.jsx)(SignatureModal, {
                            open: g,
                            setOpen: h
                        }), t ? e.switchToActiveChain && T && I ? (0, C.jsx)(SwitchNetworkButton, {
                            style: e.style,
                            className: e.className
                        }) : L ? (0, C.jsxs)(l.B, {
                            variant: "primary",
                            onClick: signIn,
                            "data-theme": s,
                            className: `${ey}--sign-in ${e.className||""}`,
                            style: e.style,
                            ...
                            children: [(0, C.jsxs)(l.C, {
                                ...
                                children: [(0, C.jsx)(LockIcon, {
                                    size: l.i.sm
                                }), (0, C.jsx)("span", {
                                    children: " Sign in "
                                })]
                            }), (0, C.jsx)("span", {
                                children: shortenAddress(u || "", !0)
                            })]
                        }) : (0, C.jsx)(ConnectedWalletDetails, {
                            theme: s,
                            networkSelector: e.networkSelector,
                            dropdownPosition: e.dropdownPosition,
                            className: e.className,
                            style: e.style,
                            detailsBtn: e.detailsBtn,
                            hideTestnetFaucet: e.hideTestnetFaucet,
                            supportedTokens: w,
                            displayBalanceToken: e.displayBalanceToken,
                            onDisconnect: () => {
                                N ? .authUrl && (D(), e ? .auth ? .onLogout ? .())
                            }
                        }) : (0, C.jsx)(em, {
                            disabled: a,
                            className: `${e.className||""} ${ey}`,
                            "data-theme": s,
                            "data-is-loading": a,
                            variant: "primary",
                            type: "button",
                            ...
                            "aria-label": "connecting" === n ? "Connecting" : d,
                            onClick: () => {
                                let t = e.modalSize || "wide";
                                ((0, l.e)() || 1 === o.length) && (t = "compact"), j({
                                    title: e.modalTitle || l.H,
                                    theme: s,
                                    data: void 0,
                                    modalSize: t,
                                    ...
                                    titleIconUrl: e.modalTitleIconUrl
                                }), M(!0)
                            },
                            "data-test": "connect-wallet-button",
                            children: a ? (0, C.jsx)(l.c, {
                                size: "sm",
            ...
            function SwitchNetworkButton(e) {
                let {
                    activeChain: t
                } = (0, r.tNP)(), i = (0, r.o$C)(), [s, n] = (0, c.useState)(!1);
                return (0, C.jsx)(em, {
                    className: `${ey}--switch-network ${e.className||""}`,
                    variant: "primary",
                    type: "button",
                    "data-is-loading": s,
                    ...
                    "aria-label": s ? "Switching Network" : void 0,
                    children: s ? (0, C.jsx)(l.c, {
                        size: "sm",
                        color: "primaryButtonText"
                    }) : "Switch Network"
                })
...
`, GlobeIcon = e => (0, C.jsx)("svg", {
            ...
            function StartScreen() {
                ...
                if (i && "function" == typeof i) return (0, C.jsx)(i, {});
                let s = ("object" == typeof i ? i ? .title : void 0) || "Your gateway to the decentralized world",
                    n = ("object" == typeof i ? i ? .subtitle : void 0) || "Connect a wallet to get started",
                    o = "object" == typeof i ? i ? .img : void 0,
                    a = e || t;
                return (0, C.jsxs)(l.C, {
                    fullHeight: !0,
                    animate: "fadein",
                    ...
                    children: [(0, C.jsxs)(l.C, {
                        ...
                        children: [(0, C.jsx)(l.C, {
                            flex: "row",
                            center: "x",
                            children: o ? (0, C.jsx)(l.D, {
                                src: o.src,
                                width: o.width ? String(o.width) : void 0,
                                height: o.height ? String(o.height) : void 0
                            }) : (0, C.jsx)(eI, {
                                children: (0, C.jsx)(GlobeIcon, {
                                    size: "150"
                                })
                            })
                        }), (0, C.jsx)(l.S, {
...
`,
  ...
  animation: ${eT} 2s ease infinite alternate;
`,
                ConnectModalContent = e => {
                    let {
                        screen: t,
                        setScreen: i,
                        initialScreen: s
                    } = e, n = (0, r.rBi)(), o = (0, r.pX8)(), a = (0, r.qL0)(), d = (0, l.u)(), M = (0, l.m)(), j = (0, c.useContext)(l.j), x = (0, c.useContext)(l.G), u = j.title, g = j.theme, h = j.modalSize, N = (0, c.useCallback)(function() {
                        let e = !(arguments.length > 0) || void 0 === arguments[0] || arguments[0];
                        e && i(s), "connecting" === o && a(), M(!1)
                    }, [o, M, i, s, a]), y = (0, c.useCallback)(() => {
                        i(s), "connecting" === o && a()
                    }, [i, s, o, a]), m = (0, C.jsx)(l.K, {
                        title: u,
                        walletConfigs: n,
                        onGetStarted: () => {
                            i(l.r.getStarted)
                        ...
                        selectWallet: i
                    }), D = (0, C.jsx)(StartScreen, {}), getWalletUI = e => {
                        let t = e.connectUI || b.H;
                        return (0, C.jsx)(t, {
                            supportedWallets: n,
                            theme: "string" == typeof g ? g : g.type,
                            goBack: y,
                            close: N,
                            isOpen: d,
                            open: () => {
                    ...
                    return (0, C.jsx)(Q.Provider, {
                        value: t,
                        children: "wide" === h ? (0, C.jsxs)("div", {
                            style: {
                                height: "100%",
                                display: "grid",
                                gridTemplateColumns: "300px 1fr"
                            },
                            children: [(0, C.jsxs)(eL, {
                                children: [" ", m, " "]
                            }), (0, C.jsxs)(l.C, {
                                flex: "column",
                                scrollY: !0,
                                relative: !0,
                                children: [t === l.r.main && (0, C.jsx)(C.Fragment, {
                                    children: D
                                }), t === l.r.getStarted && D, "string" != typeof t && getWalletUI(t)]
                            })]
                        }) : (0, C.jsxs)(l.C, {
                            flex: "column",
                            scrollY: !0,
                            ...
                            children: [t === l.r.main && m, t === l.r.getStarted && D, "string" != typeof t && getWalletUI(t)]
                        })
                    })
                },
                ConnectModal = () => {
                    let {
                        ...
                        let e = (0, r.rBi)(),
                            t = (1 !== e.length || e[0] ? .selectUI ? l.r.main : e[0]) || l.r.main,
                            [i, s] = (0, c.useState)(t),
                            n = (0, c.useRef)(t);
                        return (0, c.useEffect)(() => {
                            t !== n.current && (n.current = t, s(t))
                        }, [t]), {
                            screen: i,
                            setScreen: s,
                            initialScreen: t
                        }
                    }(), o = (0, l.u)(), a = (0, l.m)(), d = (0, r.pX8)(), [M, j] = (0, c.useState)(d);
                    (0, c.useEffect)(() => {
                        j(d)
                    }, [d]);
                    let x = (0, r.qL0)(),
                        u = (0, r.Osb)(),
                        g = !!u ? .getPersonalWallet(),
                        h = "string" != typeof i && !!i.personalWallets;
                    return (0, c.useEffect)(() => {
                        g || !h || o || "connected" !== d || "connecting" !== M || a(!0)
                    }, [o, d, a, h, g, M]), (0, C.jsx)(CustomThemeProvider, {
                        theme: e,
                        children: (0, C.jsx)(Modal, {
                            size: t,
                            open: o,
                            setOpen: e => {
                                a(e), e || s(n), "connecting" === d && x()
                            },
                            children: (0, C.jsx)(ConnectModalContent, {
                                initialScreen: n,
                                screen: i,
                                setScreen: s
                            })
...
`;
            let CarbonDocumentUnknown = e => (0, C.jsxs)("svg", {
                    width: "1em",
                    height: "1em",
                    viewBox: "0 0 32 32",
                    ...e,
                ...
                CarbonDocumentAudio = e => (0, C.jsxs)("svg", {
                    width: "1em",
                    height: "1em",
                    viewBox: "0 0 32 32",
                    ...e,
                ...
                CarbonPauseFilled = e => (0, C.jsx)("svg", {
                    width: "1em",
                    height: "1em",
                    viewBox: "0 0 32 32",
                    ...e,
                ...
                CarbonPlayFilledAlt = e => (0, C.jsx)("svg", {
                    width: "1em",
                    height: "1em",
                    viewBox: "0 0 32 32",
                    ...e,
                ...
                ew = (0, c.lazy)(() => Promise.all([i.e(6689), i.e(5750), i.e(7193)]).then(i.bind(i, 67193))),
                PlayButton = e => {
                    let {
                        onClick: t,
                        isPlaying: i
                    } = e, [s, n] = (0, c.useState)(!1);
                    return (0, C.jsx)("button", {
                        ...
                        onMouseDown: () => n(!1),
                        onMouseUp: () => n(!0),
                        children: i ? (0, C.jsx)(CarbonPauseFilled, {
                            style: {
                                width: "66%",
                                height: "66%"
                            }
                        }) : (0, C.jsx)(CarbonPlayFilledAlt, {
                            style: {
                                width: "66%",
                                height: "66%"
                            }
                ...
                ep = c.forwardRef((e, t) => {
                    let {
                        ...
                        controls: d,
                        ...M
                    } = e, j = (0, c.useRef)(null), [x, u] = (0, c.useState)(!o), [g, h] = (0, c.useState)(!0);
                    return (0, c.useEffect)(() => {
                        if (j.current) {
                            if (x) try {
                                j.current.play()
            ...
            ep.displayName = "VideoPlayer";
            let ez = c.forwardRef((e, t) => {
                let {
                    src: i,
                    alt: s,
                    poster: n,
                    ...
                    width: l,
                    ...r
                } = e, d = (0, c.useRef)(null), [M, j] = (0, c.useState)(!1), [x, u] = (0, c.useState)(!0);
                return (0, c.useEffect)(() => {
                    d.current && (M ? d.current.play() : (d.current.pause(), d.current.currentTime = 0))
                }, [M]), (0, C.jsxs)("div", {
                    style: {
                        position: "relative",
                        ...o
                    ...
                    children: [n ? (0, C.jsx)("img", {
                        ...
                        children: (0, C.jsx)(CarbonDocumentAudio, {
                            style: {
                                height: "64px",
                                width: "64px"
                            }
            ...
            ez.displayName = "AudioPlayer";
            let eb = c.forwardRef((e, t) => {
                let {
                    src: i,
                    alt: s,
                    poster: n,
            ...
            eb.displayName = "IframePlayer";
            let eS = c.forwardRef((e, t) => {
                let {
                    src: i,
                    alt: s,
                    style: n,
                ...
                return (0, C.jsx)("div", {
                    ...
                    children: (0, C.jsx)("div", {
                        ...
                        children: (0, C.jsxs)("div", {
                            ...
                            children: [(0, C.jsx)(CarbonDocumentUnknown, {
                                style: {
                                    maxWidth: "128px",
                                    minWidth: "48px",
                                    width: "50%",
            ...
            eS.displayName = "LinkPlayer";
            let eA = c.forwardRef((e, t) => {
                var i, o;
                let {
                    src: a,
                    poster: l,
                    ...
                    height: x,
                    ...u
                }, y = useResolvedMediaType(a ? ? void 0, g, d), m = useResolvedMediaType(l ? ? void 0, void 0, d);
                return y.mimeType ? y.mimeType.startsWith("text/html") ? (0, C.jsx)(eb, {
                    style: N,
                    src: y.url,
                    poster: m.url,
                    requireInteraction: M,
                    ...h
                }) : y.mimeType.startsWith("model") ? (0, C.jsx)(c.Suspense, {
                    fallback: l ? (0, C.jsx)("img", {
                        style: N,
                        src: l,
                        alt: r,
                        ref: t,
                ...
                }) : ((i = y.mimeType) && i.startsWith("video/") ? (s || (s = document.createElement("video")), s.canPlayType(i)) : "") ? (0, C.jsx)(ep, {
                    style: N,
                    src: y.url,
                    poster: m.url,
                    requireInteraction: M,
                    ...h
                }) : ((o = y.mimeType) && o.startsWith("audio/") ? (n || (n = document.createElement("audio")), n.canPlayType(o)) : "") ? (0, C.jsx)(ez, {
                    style: N,
                    src: y.url,
                    poster: m.url,
                    requireInteraction: M,
                    ...h
                }) : y.mimeType.startsWith("image/") ? (0, C.jsx)("img", {
                    style: N,
                    src: y.url,
                    alt: r,
                    ref: t,
            ...
            function useResolvedMediaType(e, t, i) {
                let s = (0, r.y$C)(),
                    n = (0, c.useMemo)(() => e ? i ? e.replace("ipfs://", i) : s ? s.resolveScheme(e) : e.replace("ipfs://", "https://ipfs.io/ipfs/") : "", [e, s, i]),
                    o = (0, M.a)(["mime-type", n], () => (0, r.WPQ)(n), {
                        enabled: !!n && !t,
                        initialData: t
                    });
                return {
            ...
            eA.displayName = "MediaRenderer";
            let ef = c.forwardRef((e, t) => {
                let {
                    metadata: i,
                    width: s = "300px",
                    height: n = "300px",
            ...
            ef.displayName = "ThirdwebNftMedia";
            let eE = j.F4 `
from {
    opacity: 0;
...
`;
  ...
  box-shadow: ${l.p.md};
  will-change: transform, opacity;
  animation: ${eE} 400ms cubic-bezier(0.16, 1, 0.3, 1);
            ...
            let signerWallet = e => ({
                ...
                ThirdwebProvider = e => {
                    let {
                        ...
                        theme: n,
                        ...o
                    } = e, a = t || b.d, d = n || "dark", M = (0, c.useMemo)(() => s ? signerWallet(s) : void 0, [s]);
                    return (0, C.jsx)(l.O, {
                        theme: d,
                        children: (0, C.jsx)(CustomThemeProvider, {
                            theme: d,
                            children: (0, C.jsxs)(r.gtM, { ...o,
                                theme: "string" == typeof d ? d : d.type,
                                supportedWallets: a,
                                signerWallet: M,
                                children: [i, (0, C.jsx)(ConnectModal, {})]
                            })
                        })
                    })
                }
